...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/healthmy">
...
<td>
 ...
 <a href="<%=path %>/healthedit?id=${c.id}&forword=healthmy" class="btn btn-default">修改</a> |
 <a href="healthdel?id=${c.id}&forword=healthmy" onClick="return confirm('您确定要删除吗?')" class="btn btn-default">删除</a>
	       ...
	       function go(index)
           {
               window.location.href="<%=path %>/healthmy?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
