...
</script><form name="formAdd" method="post" action="<%=path %>/healthinsert" class="form-horizontal" role="form">
	<fieldset> <legend>添加体检记录</legend>	
...
<div class="form-group">
             <label class="col-sm-2 control-label" for="danwei">检查医院</label>
              <div class="col-sm-4">
<input name="danwei" type="text" id="danwei" value="" placeholder="检查医院" class="form-control" >
...
<div class="form-group">
             <label class="col-sm-2 control-label" for="xiangmu">检查项目</label>
              <div class="col-sm-4">
<input name="xiangmu" type="text" id="xiangmu" value="" placeholder="检查项目" class="form-control" >
...
<div class="form-group">
             <label class="col-sm-2 control-label" for="jieguo">检查结果</label>
              <div class="col-sm-4">
<input name="jieguo" type="text" id="jieguo" value="" placeholder="检查结果" class="form-control" >
...
<div class="form-group">
             <label class="col-sm-2 control-label" for="cuoshi">采取措施</label>
              <div class="col-sm-4">
<input name="cuoshi" type="text" id="cuoshi" value="" placeholder="采取措施" class="form-control" >
     ...
     <legend></legend>
		<div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
			       <input name="forword" type="hidden" value="healthmy"/>
